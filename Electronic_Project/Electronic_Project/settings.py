"""
Django settings for Electronic_Project project.
...
SECRET_KEY = 'django-insecure-g*0in$%p$o^4o-%s9+rv^^o1)&g3w^%*cwh(=yz8p8q5d5cy#='
...
ROOT_URLCONF = 'Electronic_Project.urls'
...
WSGI_APPLICATION = 'Electronic_Project.wsgi.application'
